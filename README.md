...
> Answer: With client-side routing, all the data is sent when the page first loads up. So no need to get data from a server when a user clicks something, everything is already there. Makes for a smoother user experience.
